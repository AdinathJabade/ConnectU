...
const AlumniFields = ({ form, handleChange, showPassword, setShowPassword, errors = {} }) => {
    ...
    <>
      <div className="relative group mb-4" ref={el => (fieldsRef.current[0] = el)}>
        ...
        <input
          ...
          className={`w-full pl-10 px-4 py-3 border-2 rounded-lg focus:outline-none focus:border-indigo-500 transition bg-indigo-50 group-hover:shadow-lg ${errors.name ? 'border-red-400' : 'border-indigo-200'}`}
          value={form.name}
      ...
      <div className="relative group mb-4" ref={el => (fieldsRef.current[1] = el)}>
        <span className="absolute left-4 top-1/2 -translate-y-1/2 text-indigo-400 pointer-events-none">
        ...
        <input
          ...
          className={`w-full pl-10 px-4 py-3 border-2 rounded-lg focus:outline-none focus:border-indigo-500 transition bg-indigo-50 group-hover:shadow-lg ${errors.passoutYear ? 'border-red-400' : 'border-indigo-200'}`}
          value={form.passoutYear}
          onChange={handleChange}
          required
        />
        {errors.passoutYear && <p className="text-red-500 text-xs mt-1 ml-2">{errors.passoutYear}</p>}
      </div>
      <div className="relative group mb-4" ref={el => (fieldsRef.current[2] = el)}>
        <span className="absolute left-4 top-1/2 -translate-y-1/2 text-indigo-400 pointer-events-none">
      ...
      <div className="relative group mb-2" ref={el => (fieldsRef.current[3] = el)}>
        <span className="absolute left-4 top-1/2 -translate-y-1/2 text-indigo-400 pointer-events-none">
